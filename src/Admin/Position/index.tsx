...
const PositionPage: React.FC = () => {
  ...
  const { mutateAsync: updatePosition } = useMutation({
    mutationFn: (body: any) =>
      getMutationMethod("PUT", `api/positions/${body.id}`, body, true),
    onSuccess: (_data) => {
      fetchPositions(positionFilter);
      showToast("Position successfully updated", "success");
    },
    onError: async (error) => {
      console.log(error?.message);
      showToast("Position update unsuccessful", "error");
    },
  });

  const { mutateAsync: deletePosition } = useMutation({
    mutationFn: (id: number) =>
      getMutationMethod("DELETE", `api/positions/${id}`, {}, true),
    onSuccess: (_data) => {
      fetchPositions(positionFilter);
      showToast("Position successfully deleted", "success");
    },
    onError: async (error) => {
      console.log(error?.message);
      showToast("Position deletion unsuccessful", "error");
    },
  });
