                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none bg-white cursor-pointer ${errors.requestType
                          ? "border-red-300"
                          : "border-gray-300"
                        }`}
                    >
