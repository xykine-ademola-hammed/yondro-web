    ...
    try {
      ...
      const accountData = {
        ...
        parent_id: formData.parent_id
          ...
          : undefined,
        accountType: mapNcoaToAccountType(selectedNcoaCode!.economic_type),
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                className={`block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${errors.name ? "border-red-300" : ""
                  }`}
            ...
            <div>
              ...
              <select
                ...
                className={`block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${errors.account_class ? "border-red-300" : ""
                  }`}
              >
            ...
            <div>
              ...
              <select
                ...
                className={`block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${errors.fiscal_year_id ? "border-red-300" : ""
                  }`}
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-7 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${errors.allocation_base ? "border-red-300" : ""
                    }`}
                  placeholder="0.00"
                />
              </div>
